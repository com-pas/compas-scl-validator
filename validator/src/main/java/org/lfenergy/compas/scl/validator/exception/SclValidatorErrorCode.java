...
public class SclValidatorErrorCode {
    ...
    public static final String PREPARE_OCL_TEMP_FILES_FAILED = "SVS-2003";
    public static final String OCL_MODEL_PACKAGE_NOT_FOUND = "SVS-2004";
    public static final String NO_URI_PASSED = "SVS-2005";
}
